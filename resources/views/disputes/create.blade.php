        ...
        <div class="w-full max-w-2xl rounded-xl border border-outline-variant bg-surface-container-lowest p-6 md:p-8">
            <div class="mb-8">
                <p class="font-body-lg text-body-lg text-on-surface-variant">
                    Nous sommes désolés que votre expérience n'ait pas été satisfaisante. Décrivez le problème
                    rencontré sur la demande
            ...
            <form action="{{ route('disputes.store', $serviceRequest) }}" method="POST" enctype="multipart/form-data" class="space-y-6"
                ...
                <div>
                    <label for="reason" class="mb-2 block font-body-md text-body-md text-on-surface">Motif du litige</label>
                    <div class="relative">
                        <select id="reason" name="reason" required
                            ...
                            <option value="" disabled @selected(! old('reason'))>Sélectionnez un motif…</option>
                ...
                <div>
                    <label for="description" class="mb-2 block font-body-md text-body-md text-on-surface">Description détaillée</label>
                ...
                <div>
                    <label class="mb-2 block font-body-md text-body-md text-on-surface">Preuves visuelles (facultatif)</label>
                    <p class="mb-3 font-body-md text-sm text-on-surface-variant">
                        Ajoutez jusqu'à trois photos pour aider à trancher plus vite.
                    </p>
                    <x-file-input name="evidence" accept="image/*" multiple
                                  label="Ajouter des photos"
                                  hint="Aucune photo choisie." />
                ...
                <div class="mt-8 border-t border-outline-variant pt-6">
                    ...
                    <div class="mb-6 flex items-start gap-3 rounded-lg border border-error-container bg-error-container/20 p-4">
                        ...
                        <p class="font-body-md text-sm text-on-surface">
                            Les fausses déclarations peuvent entraîner la suspension de votre compte.
