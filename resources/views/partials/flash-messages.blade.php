...
@if ($flashStatus && ! in_array($flashStatus, $breezeStatusTokens, true))
    <div class="max-w-container mx-auto px-margin-mobile md:px-margin-desktop pt-4">
        <div class="rounded-lg bg-secondary-container/40 border border-outline-variant px-4 py-3 text-label-lg text-on-secondary-container">
            {{ $flashStatus }}
        </div>
    </div>
@endif
...
@if ($errors->any())
    <div class="max-w-container mx-auto px-margin-mobile md:px-margin-desktop pt-4">
        <div class="rounded-lg bg-error-container border border-outline-variant px-4 py-3 text-label-lg text-on-error-container">
