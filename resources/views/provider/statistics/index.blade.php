                    ...
                    <ul class="mt-4 divide-y divide-outline-variant">
                        @foreach ($stats['top_services'] as $service)
                            <li class="flex items-center justify-between gap-4 py-2">
                                <span class="text-label-md text-on-surface truncate">{{ $service['title'] }}</span>
                                <span class="font-label-numeric text-label-md text-on-surface-variant shrink-0">{{ $service['requests'] }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
