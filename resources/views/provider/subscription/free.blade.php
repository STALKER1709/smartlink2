    ...
    <div class="max-w-xl mx-auto px-margin-mobile md:px-margin-desktop py-8">
        <div class="-mx-margin-mobile border-y border-outline-variant bg-surface-container-lowest px-margin-mobile py-6 md:mx-0 md:rounded-xl md:border md:p-6">
            ...
            {{-- Ce que la formule ouvre, et surtout ce qu'elle ferme : un
                 ...
                 victime d'une panne. --}}
            <p class="mt-6 text-sm font-semibold text-on-surface">{{ __('ui.subscription.free_included') }}</p>
            <ul class="mt-2 space-y-1.5 text-sm text-on-surface">
                <li class="flex gap-2">
            ...
            <p class="mt-6 text-sm font-semibold text-on-surface">{{ __('ui.subscription.free_excluded') }}</p>
            ...
            <div class="mt-6 rounded-lg bg-secondary-container/20 border border-outline-variant p-4 text-sm text-on-secondary-container space-y-2">
