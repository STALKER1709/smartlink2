<x-app-layout>
    ...
    <section class="bg-indigo-600">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
            ...
            <form action="{{ route('services.index') }}" method="GET" class="mt-8 max-w-xl mx-auto flex gap-2">
                ...
                >
                <button type="submit" class="rounded-md bg-white px-5 py-2.5 text-sm font-semibold text-indigo-600 hover:bg-indigo-50">
                    Rechercher
                </button>
            </form>
        </div>
        ...
        <div class="mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            @foreach ($categories as $category)
                <a
                    ...
                    class="flex flex-col items-center justify-center gap-2 bg-white rounded-lg border border-gray-200 p-4 text-center hover:shadow-md hover:border-indigo-200 transition"
                >
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('services.index') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">
                Voir tout →
            </a>
        </div>
    ...
    @guest
        <section class="bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
                ...
                <a href="{{ route('register') }}" class="mt-6 inline-flex rounded-md bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700">
